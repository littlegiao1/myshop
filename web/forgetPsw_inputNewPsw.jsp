...
<div class="container">
    ...
    <div class="mid">
        <form class="form" id="inputUserAnswer">
            ...
            <div class="form-group">
                ...
                <span id="user_question">密保问题?</span>
            </div>
            ...
            <button type="nextTipButton" id="Button" class="btn btn-danger"
...
<script type="text/javascript">
        ...
        $('#nextTipButton').on('click', function () {
                $.post("login.action", $("#inputUserAnswer").serialize(), function (data1) {
                    console.log("ok");
                    console.log(data1);
                    if (data1 == "admin") {
                        layer.alert('欢迎管理员登录', {icon: 6});
